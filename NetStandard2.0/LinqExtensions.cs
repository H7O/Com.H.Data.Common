    ...
    internal static class LinqExtensions
    {
                 ...
                 :
                          (
                           ...
                           && (checkRoot = null) == null
                              ...
                              (checkRoot != null ? default : findChild(i, n))
                );
            ...
            )
        {
            ...
            if (checkRoot != null)
            {
                ...
                return FindDescendants(traversableItem,
                    path.Substring(nodes[0].Length)
                    //path[nodes[0].Length..]
                    ,
                    findChildren, pathDelimiters);
            }
...
#pragma warning disable CS8603 // Possible null reference return.
                                  ...
                                  null
                                  :
                                   i?.Where(x => x != null && !EqualityComparer<T>.Default.Equals(x, default))
